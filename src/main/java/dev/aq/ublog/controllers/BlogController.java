...
import dev.aq.ublog.services.FileService;
...
public class BlogController {
  ...
  public ResponseEntity<Object> getBlogById(@PathVariable Long blogId) {
    ...
    try {
      BlogDto blogDtoById = blogService.getBlogById(blogId);
  ...
  public ResponseEntity<Object> getBlogByCategory(
    ...
    try {
      BlogResponse blogsByCategoryResponse = blogService.getBlogsByCategory(categoryId, pageNumber, pageSize, sortBy, sortDir);
  ...
  public ResponseEntity<Object> getBlogByUser(
    ...
    try {
      BlogResponse blogsByUser = blogService.getBlogsByUser(userId, pageNumber, pageSize, sortBy, sortDir);
  ...
  public ResponseEntity<Object> createBlog(
    ...
    try {
      if (Objects.nonNull(userId) && Objects.nonNull(categoryId)) {
        BlogDto newBlogDto = blogService.createBlog(blogDTO, userId, categoryId);
  ...
  public ResponseEntity<Object> searchBlogs(@PathVariable String keyword) {
    ...
    List<BlogDto> searchedBlogs = blogService.searchByTitle(keyword);
